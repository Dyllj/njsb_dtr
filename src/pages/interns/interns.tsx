  ...
  return (
    <div className="flex flex-col gap-6 pt-4">
      <header className="pb-4 border-b border-border">
        ...
        <p className="text-sm text-muted-foreground mt-1">Manage intern records and access</p>
      </header>

      <section className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4" aria-labelledby="interns-actions-heading">
        <h2 id="interns-actions-heading" className="sr-only">Intern Actions</h2>
        <div className="relative w-full sm:w-72">
          <Search className="pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-muted-foreground" aria-hidden="true" />
          <label htmlFor="search-interns" className="sr-only">Search interns</label>
          <input
            id="search-interns"
            type="search"
            value={query}
            ...
            className="w-full pl-9 pr-4 py-2 rounded-md border border-input bg-background focus:outline-none focus:ring-2 focus:ring-ring"
          />
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  disabled={submitting}
                >
                  <SelectTrigger size="sm" aria-label="Select intern status">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
      ...
      <section aria-labelledby="all-interns-heading">
        <Card>
          <CardHeader>
            <CardTitle id="all-interns-heading">All Interns</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead scope="col" className="text-right">Total hours</TableHead>
                    <TableHead scope="col" className="text-right">Accumulated hours</TableHead>
                    <TableHead scope="col" className="text-right">Remaining hours</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {filtered.length === 0 ? (
